...
SECRET_KEY = 'django-insecure-8c+1d9^w$-6p(ahm2a)*8^)a8!^ee7(#o#!co$t)okpn#3ingp'
...
CRISPY_ALLOWED_TEMPATE_PACKS = "bootstrap5"
...
WSGI_APPLICATION = 'makeup.wsgi.application'
